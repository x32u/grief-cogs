...
class EventMixin:
    ...
    async def get_event_colour(
        ...
        defaults = {
            ...
            "user_change": discord.Colour.dark_theme(),
            "role_change": discord.Colour.dark_theme(),
            "role_create": discord.Colour.dark_theme(),
            "role_delete": discord.Colour.dark_theme(),
            "voice_change": discord.Colour.dark_theme(),
            "user_join": discord.Colour.dark_theme(),
            "user_left": discord.Colour.dark_theme(),
            "channel_change": discord.Colour.dark_theme(),
            "channel_create": discord.Colour.dark_theme(),
            "channel_delete": discord.Colour.dark_theme(),
            "guild_change": discord.Colour.dark_theme(),
            "emoji_change": discord.Colour.dark_theme(),
            "stickers_change": discord.Colour.dark_theme(),
            "invite_created": discord.Colour.dark_theme(),
            "invite_deleted": discord.Colour.dark_theme(),
            "thread_change": discord.Colour.dark_theme(),
            "thread_create": discord.Colour.dark_theme(),
            "thread_delete": discord.Colour.dark_theme(),
        }
