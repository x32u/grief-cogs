...
# the following regex is slightly modified from Grief
...
# https://github.com/Cog-Creators/Grief-DiscordBot/blob/V3/develop/redbot/core/commands/converter.py#L55
