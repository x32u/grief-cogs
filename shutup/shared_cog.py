...
from grief.cogs.downloader.repo_manager import Repo
from grief.core import data_manager
from grief.core._diagnoser import IssueDiagnoser
...
class SharedCog(Cog, name="AAA3A_utils"):
    ...
    async def getallfor(
        ...
        ##################################################
        red_table = Table("Key", "Value", title="Grief instance informations")
        red_table.add_row("Grief version", str(redver))
