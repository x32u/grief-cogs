...
from grief.core.utils.chat_formatting import humanize_list, inline, warning
...
#     @classmethod
#     def _setup(cls, bot: Grief, cog: commands.Cog) -> None:
#         """
...
class Cog(commands.Cog):
    ...
    async def cog_load(self) -> None:
        ...
        # Prevent Grief `(timeout)` error.
        asyncio.create_task(self.cog_load_new_task())

    async def cog_load_new_task(self) -> None:
        # Wait until Grief ready. But `(timeout)` when cog loading when bot starting...
