...
from grief.core import Config  # isort:skip
...
import sentry_sdk
from grief.core import __version__ as red_version
...
class SentryHelper:
    def __init__(self, bot: Grief, cog: commands.Cog) -> None:
        ...
        self.sentry_enabled: bool = False
        self.display_sentry_manual_command: bool = False
        self.send_reminders: bool = False
        ...
        self.sentry_global: typing.Dict[
            ...
            "sentry": {
                ...
                "display_sentry_manual_command": False,
